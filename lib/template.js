...
const createDirectories = async () => {
  if (!fs.existsSync(BASE_DIR)) {
    console.log('Creating base template working directories');
...
const createRootCfgFiles = async () => {
  console.log(
    'Creating PostCSS, .gitignore and .browserslistrc configuration files'
  );
...
const createSourceCodeFiles = async () => {
  console.log('Creating starting point source code files');
...
const createEmptyFiles = async () => {
  console.log('Creating empty tmeplate files');
